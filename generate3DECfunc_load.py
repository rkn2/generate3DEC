...
class generateFile:
    def __init__(self, file_path, blockTypes, blockGroups, movieInterval, dampLocal, functions, solveRatio, facetri, maxLoad, interval, 
                 finalOutput = None,
    ...
    def writeFunctions(self):
        ...
        for i in range(numFunctions):
            ...
            if self.facetri != 'true':
                functiondata = re.sub(r'\bfacetri rad8\b', '' , functiondata)
            ...
            functiondata = re.sub(r'\bsolveRatio\b', self.solveRatio, functiondata)
